  ...
  @Override public void run()
  {
    ...
    while(true)
    {
      ...
      switch (random.nextInt(5)) {
        case 0:
            gemDeposit.addToGemDeposit(GemMine.getValuable("Diamond"));
            try
            {
              Thread.sleep(2000);
            }
            ...
            break;
          case 1:
            gemDeposit.addToGemDeposit(GemMine.getValuable("Gold Nugget"));
            try
            {
              Thread.sleep(1500);
            }
            ...
            break;
          case 2:
            gemDeposit.addToGemDeposit(GemMine.getValuable("Jewel"));
            try
            {
              Thread.sleep(1000);
            }
            ...
            break;
          case 3:
            gemDeposit.addToGemDeposit(GemMine.getValuable("Ruby"));
            try
            {
              Thread.sleep(500);
            }
